...
if __name__ == "__main__":
    ...
    for itr in p(range(epoch * per_epoch)):
        # init
        ...
        network['t_label'] = t_label
        network['t_label_one_hot'] = one_hot_vector(t_label)

        # forwarding
        forward_data = forward()

        # back propagation
        back_prop(forward_data)
    ...
    np.savez('params.npz', w1=network['w1'], w2=network['w2'], b1=network['b1'], b2=network['b2'])
